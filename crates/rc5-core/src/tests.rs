mod standard_examples {
    ...
    type Word = u32;
    type Arith = crate::words::StdArith;
    type ByteRepr = crate::words::LittleEndian;
    type Magic = crate::words::StdMagic;
    ...
    fn round_trip() {
        ...
        crate::algs::expand_key::<Word, R, B, Magic, ByteRepr, Arith>(
            &key,
            &mut l_table,
            &mut s_table,
        );
